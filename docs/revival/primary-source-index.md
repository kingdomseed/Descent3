...
| InsanityBringer [PiccuEngine](https://github.com/InsanityBringer/PiccuEngine), from its [`df209742` initial import](https://github.com/InsanityBringer/PiccuEngine/commit/df209742fcda59d466b849eff9ee0e7b908d7d40), with [shared pre-divergence revision `61bb9a33`](https://github.com/InsanityBringer/PiccuEngine/commit/61bb9a337d958be9b4716d67d548a06194ff2b5e), stable [`v1.2.2` at `7c2535c4`](https://github.com/InsanityBringer/PiccuEngine/commit/7c2535c4662c9fd8a4c3de54a2ab346b1a605ff6), and maintained review snapshot [`de4237ab`](https://github.com/InsanityBringer/PiccuEngine/commit/de4237abf67adc4eefded17bfcd09685ab311e87) | Secondary differential evidence for community-discovered defects, restored behavior, quality-of-life semantics, and affected source regions; use the stable tag for released experience evidence and the exact maintained snapshot for current source archaeology | GPL evidence does not replace the pinned DescentDevelopers source or retail behavior. Keep unfinished branch work distinct from stable behavior; Windows, OpenGL, OpenAL, and SDL mechanisms are not Revival architecture. PiccuEngine's broad InjectD3-inclusion claim is a lead, not complete provenance; verify each adopted delta and retain exact GPL provenance for any translated code or formula |
