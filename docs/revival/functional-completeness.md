...
- package publishing, provenance, signing where required, and distribution, followed by a distinct RevivalMac intake and local-library path that validates, stages, installs, activates, disables, replaces or removes native packages without a marketplace, cloud account, or hosted service;
