...
| R-012 | Authored-resolution terrain cells, sky, stars, satellites and atmosphere | `Descent3/terrainrender.cpp`, `editor/` | Core, Metal, Editor / 2–8 | Deterministic 32-by-32-quad partition, seam-free streamed borders, full authored resolution without runtime LOD, outdoor traversal, and complete environment authoring | specified |
...
| R-014 | World-stream demand, Metal I/O, residency and frame-safe retirement | New native contract; room/portal and terrain topology are source evidence | Core, Metal, Mac / 1–10 | Orientation-independent spatial demand and lead-time shell for every supported simultaneous camera profile; package-intake integrity; direct bounded Metal I/O; initial and discontinuous readiness; out-of-order and bounded stale completion; atomic next-frame install; retirement after final GPU use; old-generation submission cutoff and committed-I/O, allocation, file-handle and render drain before handoff; stall/input reset; no-overlap level and stack transition; repeated churn beyond active capacity; I/O and late-envelope failure; clean Metal validation; bounded memory; and identical authoritative hashes under varied completion order | specified |
...
| W-012 | Selection, grouping, search, naming and reference navigation | `editor/` | Editor / 2–8 | Synchronized Outliner, viewport, Inspector and Problems selection; direct and numeric editing; find references; named undo/redo; focus restoration; and save/reopen | specified |
...
| W-019 | Streaming-cell inspection and transition diagnostics | New native creator contract | Core, Metal, Editor / 2–8 | Room and terrain cell overlays; desired/loading/ready/active/retiring state; shared-resource and deduplicated byte totals; camera envelopes, prefetch shell, simultaneous-view, destination and lead-time diagnostics; generation-bound shipping-format preview layers; three-slice frame-safe `DraftOverlay` sized to the four-viewport visible dirty-geometry union; complete key-document and content-stack residency and I/O handoff; source-linked seam and budget failures; save/reopen; playtest; and publication | specified |
| W-020 | Native project window, workspace and human interaction quality | New native creator contract | Editor / 2–10 | One AppKit document and primary project window; navigator, Outliner, tabbed canvases, Inspector and Problems/Activity panes; standard menus and shortcuts; one/two/four view layouts; persistent local layout; command discoverability; keyboard and VoiceOver paths; and measured M4 responsiveness | specified |
| W-021 | Revision-safe editor background operations | New native creator contract | Core, Editor / 2–10 | Immutable source snapshots, visible progress, cancellation, transient `ProjectEditGeneration` result identity, stale-result refusal, source-linked failure, generation-bound preview products, continued unrelated inspection, and no overwrite of newer edits or last-good derived products | specified |
...
| T-015 | Finite-world cell construction and streaming-budget validation | Historical level-load closure, room/portal topology, terrain grid, `manage/`, renderer caches and terrain LOD as rejected-mechanism evidence | Import, Core, Metal, Editor / 1–8 | Deterministic room and positive-multiple-of-32 terrain cells; stack-global, resident-spine, schema-count and level-pinned caps; complete per-cell dependency closure and conservative presentation-demand bounds; checked layer/blob locators, ranges, closed descriptors and hashes; exact GPU bytes; spatial camera, simultaneous-view and discontinuous-destination envelopes; demand-evaluation, `LoadWave`, queue, command-buffer, stale-work, active-high-water and movement-lead-time limits; malformed, oversized and late-envelope refusal; and proof that aggregate streamed presentation bytes alone do not reject a finite level | specified |
