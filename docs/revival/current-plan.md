...
| Current local toolchain | Xcode 26.6 and Swift 6.3.3 were observed on July 16, 2026. They remain archaeology tools, not a product compatibility lane. |
| Product start blocker | Install and select Xcode 27 with Swift 6.4 in Swift 6 language mode and record the macOS/iOS SDK and deployment environment. |
